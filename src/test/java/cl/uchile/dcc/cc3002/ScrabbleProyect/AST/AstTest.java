...
public class AstTest {
    ...
    void setUp(){
        ...
        tree2 = new Tree(new Add(new Add(Str1,Str1),new Add(Int2,new Or(new And(new Sub(Bin1,new Multiply(Int1,Bin2)),Bin2),Bool))));
    ...
    void EvaluateAstTest(){
        ...
        var Tree2Expected = (StringType) (Str1.Add(Str1)).Add(Int2.Add((IOperations) (((ILogicOperations) Bin1.Subtract(Int1.Multiply(Bin2))).Conjunction(Bin2)).Disjunction(Bool)));
