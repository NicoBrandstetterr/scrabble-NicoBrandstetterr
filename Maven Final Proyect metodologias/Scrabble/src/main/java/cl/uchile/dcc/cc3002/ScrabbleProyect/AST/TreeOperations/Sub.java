...
public class Sub extends AbstractAstOperations {
    ...
    public StringType ToString() {
        return new Tree(new Sub(left,right)).Evaluate().ToString();
    }
    ...
    public FloatType ToFloat() {
        return new Tree(new Sub(left,right)).Evaluate().ToFloat();
    }
    ...
    public IntType ToInt() {
        return new Tree(new Sub(left,right)).Evaluate().ToInt();
    }
    ...
    public BinaryType ToBinary() {
        return new Tree(new Sub(left,right)).Evaluate().ToBinary();
    }
}
