...
public class Add extends AbstractAstOperations{
    ...
    public StringType ToString() {
        return new Tree(new Add(left,right)).Evaluate().ToString();
    }
    ...
    public FloatType ToFloat() {
        return new Tree(new Add(left,right)).Evaluate().ToFloat();
    }
    ...
    public IntType ToInt() {
        return new Tree(new Add(left,right)).Evaluate().ToInt();
    }
    ...
    public BinaryType ToBinary() {
        return new Tree(new Add(left,right)).Evaluate().ToBinary();
    }
}
